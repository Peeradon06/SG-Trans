...
class Encoder(nn.Module):
    ...
    def forward(self,input,code_keyword,code_intoken,code_instatement,
...
class Transformer(nn.Module):
    ...
    def _run_forward_ml(self,
        ...
        code_rep = self.embedder(code_word_rep,
                                 ...
                                 code_type_rep,
                                 mode='encoder')
        memory_bank, layer_wise_outputs = self.encoder(code_rep,code_keyword,code_intoken,code_instatement,
                                                       code_dataflow,code_controlflow,code_len)  # B x seq_len x h
    ...
    def decode(self,
        ...
        word_rep = self.embedder(code_word_rep,
                                 ...
                                 code_type_rep,
                                 mode='encoder')
        memory_bank, layer_wise_outputs = self.encoder(word_rep,code_keyword,code_intoken,code_instatement,
                                                       code_dataflow,code_controlflow,code_len)  # B x seq_len x h
